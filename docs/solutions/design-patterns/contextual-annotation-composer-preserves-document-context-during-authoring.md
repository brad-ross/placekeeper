...
- Save Destination cancellation and command rejection preserve the exact draft without committing a Review Item or preview (`test/acceptance/production-flow.spec.ts:3865-3892`, `test/acceptance/production-flow.spec.ts:4245-4284`);
