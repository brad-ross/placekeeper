...
The release checklist must show Gatekeeper acceptance, offline launch, Finder registration, Codex plugin installation, VS Code installation, and the same review on clean arm64 and x64 Macs. These checks are still external/manual until signed and notarized release artifacts and clean test machines are available.
