...
\`\`\`mermaid
flowchart TB
  F["Finder Open With / Quick Action"] --> L["Shared launch client"]
...
- **Files:**
  ...
  - integrations/finder/PdfProofreader.workflow/
...
- **Approach:**
  ...
  2. Register a Finder Open With action and Quick Action without becoming the default PDF handler.
